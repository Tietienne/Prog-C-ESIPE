...
void reste(void){
  ...
  display_operation('?');
  display_stack();
  display_action_msg("Compute the rest");
  actualise_window();
  pause_keyboard();

  clear_window();
  display_stack();
  display_transition_1((int) rest);
  display_action_msg("Push the rest");
  actualise_window();
  pause_keyboard();
...
void facto(void){
  ...
  clear_window();
  display_stack();
  display_transition_1(f);
  display_action_msg("Push the facto");
  actualise_window();
  pause_keyboard();
